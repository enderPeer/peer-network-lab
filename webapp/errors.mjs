...
export const CATALOGUE = {
  ...
  INSUFFICIENT_BALANCE: {
    http: 400,
    why: 'You do not hold as much of that asset as the act would move. Balances are derived from the log by replay, so what the interface showed may already be one act out of date.',
